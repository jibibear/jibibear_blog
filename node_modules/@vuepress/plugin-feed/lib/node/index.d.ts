import { PageFrontmatter, Page, App, PluginFunction } from 'vuepress/core';
...
type FrontmatterAuthor = AuthorInfo | AuthorInfo[] | AuthorName | AuthorName[];
...
interface FeedPluginFrontmatter extends PageFrontmatter {
    /**
     * Feed plugin options
     *
     * Feed 插件选项
...
type FeedConfig = [path: string, content: string, contentType?: string];
...
interface FeedGetter {
     ...
     * 项目描述获取器
     */
    description?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => string | null;
    /**
     * Item excerpt getter
     *
     * 项目摘要获取器
     */
    excerpt?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => string | null;
    /**
     * Item content getter
     *
     * 项目内容获取器
     ...
     */
    author?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => FeedAuthor[];
    /**
     * Item category getter
     *
     * 项目分类获取器
     */
    category?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => FeedCategory[] | null;
    /**
     * Item enclosure getter
     *
     * 项目附件获取器
     */
    enclosure?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => FeedEnclosure | null;
    /**
     * Item publish date getter
     *
     * 项目发布日期获取器
     */
    publishDate?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => Date | null;
    /**
     * Item last update date getter
     *
     * 项目最后更新日期获取器
     */
    lastUpdateDate?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => Date;
    /**
     * Item image getter
     *
     * 项目图片获取器
     ...
     * 项目贡献者获取器
     */
    contributor?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, app: App) => FeedContributor[];
    /**
...
interface BaseFeedPluginOptions {
    /**
     ...
     * Feed 项目过滤器
     */
    filter?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>) => boolean;
    /**
     * A custom sort function, used to sort feed items.
     *
     * Feed 项目排序器
     */
    sorter?: <ExtraPageData extends Record<string, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string, unknown> = Record<never, never>>(pageA: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>, pageB: Page<ExtraPageData, ExtraPageFrontmatter & FeedPluginFrontmatter, ExtraPageFields>) => number;
    /**
...
interface FeedPluginOptions extends BaseFeedPluginOptions {
    /**
     * Deploy hostname
     *
     * 部署的域名
...
type FeedPage = Page$1<Record<string, unknown> & {
    excerpt?: string;
    git?: GitData;
}, FeedPluginFrontmatter>;

declare const feedPlugin: (options: FeedPluginOptions) => PluginFunction;

export { type AuthorInfo, type AuthorName, type BaseFeedPluginOptions, type FeedAuthor, type FeedCategory, type FeedChannelOptions, type FeedConfig, type FeedContributor, type FeedEnclosure, type FeedFrontmatterOption, type FeedGetter, type FeedPage, type FeedPluginFrontmatter, type FeedPluginOptions, type FrontmatterAuthor, feedPlugin };
