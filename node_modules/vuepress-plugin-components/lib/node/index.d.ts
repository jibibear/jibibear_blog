...
export { AVAILABLE_SERVICES, type ArtPlayerOptions, type AvailableComponent, type BuiltInShareService, type ComponentGlobalOptions, type ComponentLocaleOptions, type ComponentPluginOptions, type DeprecatedComponent, type DeprecatedComponentGlobalOptions, type PDFLocaleData, SHARE_CONFIG, type ShareAction, type ShareOptions, type ShareService, type ShareServiceConfig, type ShareServiceOptions, type ShareServiceVariableName, type SiteInfoLocaleData, type VidstackLocaleData, componentsPlugin, pdfLocaleInfo, siteInfoLocaleInfo, vidstackLocaleInfo };
